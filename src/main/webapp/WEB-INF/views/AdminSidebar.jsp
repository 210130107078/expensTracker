	...
	<ul class="sidebar-nav" id="sidebar-nav">
		...
		<li class="nav-item"><a class="nav-link collapsed"
			...
			<ul id="components-nav" class="nav-content collapse "
				...
				<li><a href="listusers"> <i class="bi bi-circle"></i><span>List
							Users</span>
				</a></li>
			</ul></li>
		<!-- End Components Nav -->
		...
		<li class="nav-item"><a class="nav-link collapsed"
			data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#"> <i
				class="bi bi-person"></i><span>Account</span><i
				class="bi bi-chevron-down ms-auto"></i>
		</a>
			<ul id="icons-nav" class="nav-content collapse "
				data-bs-parent="#sidebar-nav">
				<li><a href="newaccount"> <i class="bi bi-circle"></i><span>New Account</span>
				</a></li>
				<li><a href="listaccount"> <i class="bi bi-circle"></i><span>List Account</span>
				</a></li>
			</ul>
		</li>
		...
		<ul id="vendor-nav" class="nav-content collapse "
				...
				<li><a href="listvendor"> <i class="bi bi-circle"></i><span>List Vendor</span>
				</a></li>
			</ul>
			</li>
		...
		<ul id="category-nav" class="nav-content collapse "
				...
				<li><a href="listcategory"> <i class="bi bi-circle"></i><span>List Category</span>
				</a></li>
			</ul>
			</li>
		...
		<ul id="subcategory-nav" class="nav-content collapse "
				...
				<li><a href="listsubcategory"> <i class="bi bi-circle"></i><span>List Subcategory</span>
				</a></li>
			</ul>
			</li>
		...
		<ul id="expense-nav" class="nav-content collapse "
				...
				<li><a href="listexpense"> <i class="bi bi-circle"></i><span>List Expense</span>
				</a></li>
			</ul>
			</li>
		...
		<ul id="income-nav" class="nav-content collapse "
				...
				<li><a href="listincome"> <i class="bi bi-circle"></i><span>List Income</span>
				</a></li>
			</ul>
			</li>
		<!-- End Icons Nav -->
